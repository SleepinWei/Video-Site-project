...
class User(UserMixin,db.Model):
    ...
    levelProgress = db.Column(db.Integer) # 等级进度
    coins = db.Column(db.Integer)
    role_id = db.Column(db.Boolean, db.ForeignKey('role.id')) # 对应关系?
...
class Video(db.Model):
    ...
    def __init__(self,title,url,info,playnum,likenum,commentnum,collectionnum,coinnum,length,danmu_path,uploaduser_id):
        self.title = title
        self.url = url
        self.info = info
